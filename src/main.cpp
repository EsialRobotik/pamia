...
std::vector<RoadMap> roadMaps = {
  ...
  RoadMap(PAMI_GROUPIE_1_SRF_CODE, PAMIA_COLOR::BLUE, {
    {ROADMAP_COMMAND::CELEBRATE, 1000, SERVO_POS_LOW, SERVO_POS_HIGH, 0},
    {ROADMAP_COMMAND::WAIT, 2000, 0, 0, 0},
    {ROADMAP_COMMAND::GO_TO, 0, 1000, 0, DETECTION_THRESHOLD_CM},
    {ROADMAP_COMMAND::GO_TO, 0, 1000, 200, DETECTION_THRESHOLD_CM},
  }),
  ...
  RoadMap(PAMI_STAR_SRF_CODE, PAMIA_COLOR::BLUE, {
    {ROADMAP_COMMAND::CELEBRATE, 900, SERVO_POS_LOW, SERVO_POS_HIGH, 0},
    {ROADMAP_COMMAND::WAIT, 500, 0, 0, 0},
    {ROADMAP_COMMAND::GO_TO, 0, 1300, 0, DETECTION_THRESHOLD_CM},
    {ROADMAP_COMMAND::GO_TO, 0, 1300, -100, DETECTION_THRESHOLD_CM},
    {ROADMAP_COMMAND::GO, 0, -100, 0, DETECTION_THRESHOLD_CM},
    {ROADMAP_COMMAND::GO, 0, -100, 0, DETECTION_THRESHOLD_CM},
    {ROADMAP_COMMAND::GO_TO, 0, 1300, -230, DETECTION_THRESHOLD_CM},
  }),
