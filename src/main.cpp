...
std::vector<RoadMap> roadMaps = {
  ...
  RoadMap(PAMI_GROUPIE_1_SRF_CODE, PAMIA_COLOR::YELLOW, {
    ...
    {ROADMAP_COMMAND::GO_TO, 170, 180, 0, 0},
    {ROADMAP_COMMAND::GO_TO, 500, 800, 0, 0},
    {ROADMAP_COMMAND::FACE, 500, 3000, 0, 0},
  }),
  RoadMap(PAMI_GROUPIE_1_SRF_CODE, PAMIA_COLOR::BLUE, {
    ...
    {ROADMAP_COMMAND::WAIT, PAMI_START_WAIT_TIME + 4000, 0, 0, 0},
    {ROADMAP_COMMAND::STOP_CELEBRATE, 0, 0, 0, 0},
    {ROADMAP_COMMAND::GO_TO, 170, 2820, 0, 0},
    {ROADMAP_COMMAND::GO_TO, 500, 2200, 0, 0},
    {ROADMAP_COMMAND::FACE, 500, 0, 0, 0},
  }),
  ...
  RoadMap(PAMI_STAR_SRF_CODE, PAMIA_COLOR::YELLOW, {
    ...
    {ROADMAP_COMMAND::GO_TO, 450, 1300, 0, DETECTION_THRESHOLD_CM},
  }),
  RoadMap(PAMI_STAR_SRF_CODE, PAMIA_COLOR::BLUE, {
    ...
    {ROADMAP_COMMAND::GO_TO, 450, 1700, 0, DETECTION_THRESHOLD_CM},
  }),
};
